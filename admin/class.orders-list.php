...
class Order_Lists extends WP_List_Table {
	/** Class constructor */
	...
	public function no_items() {
		echo esc_html__( 'No orders avaliable.', 'wpccrm-copper-crm' );
	}
	...
	function get_columns() {
		$columns = [
			'id'    	=> esc_html__( 'Order Id', 'wpccrm-copper-crm' ),
			'date_created_gmt' => esc_html__( 'Create Time', 'wpccrm-copper-crm' ),
