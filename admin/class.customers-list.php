...
function wpccrm_user_final_datas($users_data) {
...
class Customers_Lists extends WP_List_Table{
    ...
    public function __construct(){
        parent::__construct(
            [
                'singular'  => esc_html__('Customer', 'wpccrm-copper-crm') ,
                'plural'    => esc_html__('Customers', 'wpccrm-copper-crm') ,
                'ajax'      => true
        ]);
    }
    ...
    public static function get_customer($per_page = 10, $page_number = 1){
        ...
        return array_map('wpccrm_user_final_datas', $result);
    }
    ...
    public function no_items(){
        echo esc_html__('No customers avaliable.', 'wpccrm-copper-crm');
    }
    ...
    function get_columns(){
        $columns = [
                'ID'                  => esc_html__('Id', 'wpccrm-copper-crm') , 
                'woocommerce_name'    => esc_html__('Name', 'wpccrm-copper-crm') , 
                'user_email'          => esc_html__('Email', 'wpccrm-copper-crm') , 
                'user_registered'     => esc_html__('Create Time', 'wpccrm-copper-crm') , 
