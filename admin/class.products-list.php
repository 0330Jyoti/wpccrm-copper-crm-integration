...
class Product_Lists extends WP_List_Table {
	/** Class constructor */
	public function __construct() {
		parent::__construct( [
			'singular' => esc_html__( 'Order', 'wpccrm-copper-crm' ), //singular name of the listed records
			'plural'   => esc_html__( 'Orders', 'wpccrm-copper-crm' ), //plural name of the listed records
	...
	public function no_items() {
		echo esc_html__( 'No products avaliable.', 'wpccrm-copper-crm' );
	}
	...
	function column_action( $item ) {	
		...
		$action = '<form action="" method="post">                      
						...
						<button class="button" name="smart_synch" value="copper" type="submit">'.esc_html__('Sync', 'wpccrm-copper-crm').'</button>
					</form>';
		return $action;
	}
	...
	function get_columns() {
		$columns = [
			'ID'    => esc_html__( 'Product Id', 'wpccrm-copper-crm' ),
			'post_title'    => esc_html__( 'Product Name', 'wpccrm-copper-crm' ),
			'meta_value'    => esc_html__( 'Sku', 'wpccrm-copper-crm' ),
			'post_date'    => esc_html__( 'Create Time', 'wpccrm-copper-crm' ),
			'action'    => esc_html__( 'Action', 'wpccrm-copper-crm' )
		];
		return $columns;
	}
